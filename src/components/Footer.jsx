  ...
  return (
    <Container>
        ...
        <Right>
            <Title>Contact</Title>
            <ContactItem>
                <Room style={{marginRight:"10px"}}/> 23 Kelvin Path , South Viman Nagar 245663
            </ContactItem>
            <ContactItem>
                <Phone style={{marginRight:"10px"}}/> +1823742930
            </ContactItem>
            <ContactItem>
                <MailOutline style={{marginRight:"10px"}} /> contact@shopify.dev
            </ContactItem>
